...
Permissions required: Waive Policy Violations
 ...
 @param ownerType Indicates the scope of the waiver. Possible values are application, organization, repository, repository_manager, repository_container, global.
...
Use this method to trigger a waiver request webhook event. The 'Waiver Request' event type should have been configured as one of the IQ Server webhooks, before using this method.
